...
const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    status: 'complete',
    statusLabel: 'Complete',
    desc: 'Boundary surveys completed. The physical limits of the estate have been precisely established and documented.',
    journal: 'Every corner of the estate mapped. The land knows its story.',
  },
  {
    num: '03',
    ...
    desc: 'Formal documentation, title processing and official registration of the property with the Akwa Ibom State authorities.',
  },
  {
    num: '04',
    ...
    status: 'active',
    statusLabel: 'In Progress',
    desc: 'The architecture, guest experience, interiors and signature spaces — The Grand Ballroom, The Still Room, Ekom Iban Pavilion — are being developed in detail.',
  },
  {
    num: '05',
    ...
    desc: 'Final technical drawings, structural engineering coordination and all required development approvals from the relevant authorities.',
  },
  {
    num: '06',
...
const PROGRESS = 18;
const PROGRESS_SUMMARY = 'Land acquired. Survey complete. Property registration and architecture underway.';
